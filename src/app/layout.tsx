...
export const metadata: Metadata = {
  ...
  description:
    'Experienced Software Engineer skilled in Javascript, Typescript, React, and Node.js. Passionate about crafting innovative tech solutions from São Paulo, Brazil.',
  openGraph: {
