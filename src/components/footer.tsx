...
export function Footer() {
  return (
    <div className="flex h-fit w-full flex-col items-center gap-12 p-6">
      <div className="flex h-2/3 flex-col items-center justify-center py-4 text-xl font-normal leading-normal tracking-tight md:text-2xl md:leading-normal lg:text-3xl lg:leading-normal">
